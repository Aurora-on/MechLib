...
abbrev impulse_momentum_theorem (p2 p1 : Momentum) (F : Force) (dt : Time)
...
abbrev momentum_conservation_inelastic (m1 m2 : Mass) (v1 v2 : Speed)
    (h : (m1 + m2).val ≠ 0) :
...
abbrev impulse_def (F : Force) (dt : Time) :
